...
app.get("/jokes/:id", (req, res) => {
  //id itu klo lu cek di postman dia letaknya sebagai path parameter
  //id yang diterima merupakan string lalu diubah nilainya menjadi integer dengan parseInt
...
app.delete("/jokes/:id", (req, res) => {
  const id = parseInt(req.params.id);
  const searchIndex = jokes.findIndex((joke) => joke.id === id);
  //Klo indexnya > -1 (artinya ada)
  if (searchIndex > -1) {
    //Splice = remove index tersebut dan hanya 1 element
    jokes.splice(searchIndex, 1);
    res.sendStatus(200);
    //Klo ngga ada maka akan error
  } else {
    res
      .status(404)
